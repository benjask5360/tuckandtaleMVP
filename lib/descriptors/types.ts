...
export type AttributeType = 'hair' | 'eyes' | 'skin' | 'body' | 'hair_length' | 'hair_type' | 'glasses' | 'pet_color' | 'magical_color' | 'background';
...
export interface EnhancedDescriptors {
  ...
  background?: string;  // e.g., "Asian", "Hispanic or Latino"
